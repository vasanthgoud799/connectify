...
export default function Dashboard() {
  ...
  const handleStartGroupCall = async () => {
    ...
    const onlineFriends = friends.filter(f => f.status === 'online').map(f => f.id.toString());
  ...
  const handleScheduleCall = async () => {
    ...
    setMeetingDate('');
    setMeetingTime('');
    navigate(`/waiting-room?callId=scheduled-${Date.now()}&hostId=${user?.id}&title=${encodeURIComponent(meetingTitle)}`);
  };
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 pl-3 border-l border-border">
                <div className="relative">
                  ...
                  <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 ${getStatusColor(presence?.status || 'offline')} rounded-full border-2 border-background`}></div>
                </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-card rounded-xl p-6 border border-border hover:shadow-md transition-shadow">
                ...
                <Button size="sm" className="w-full" onClick={handleStartInstantCall}>Start Call</Button>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border hover:shadow-md transition-shadow">
                ...
                <Button size="sm" variant="outline" className="w-full" onClick={handleStartVoiceCall}>Voice Call</Button>
              </div>
                  ...
                  <div key={friend.id} className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex items-center space-x-1">
                      <Button
                        ...
                        onClick={() => handleStartCall(friend.id.toString(), friend.name)}
